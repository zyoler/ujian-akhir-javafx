    ...
    public void save(ActionEvent actionEvent) {
        ...
        if (Objects.equals(textfieldName.getText(), "")) {
            ...
            try {
                ...
                if (employee == null) // Tambah user
                    preparedStatement = connection.prepareStatement("INSERT INTO EMPLOYEE (nama_employe, alamat_employe, no_kontak, jabatan) VALUES (?, ?, ?, ?)");
                else { // Edit user
                    preparedStatement = connection.prepareStatement("UPDATE EMPLOYEE SET NAMA_EMPLOYE = ?, ALAMAT_EMPLOYE = ?, NO_KONTAK = ?, JABATAN = ?");
