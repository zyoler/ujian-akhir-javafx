...
public class HistoryPeminjaman {
    ...
    public HistoryPeminjaman(String id_transaksi, String nama_peminjam, String alamat, String tanggal_pinjam, String tanggal_kembali, int lama_pinjam, int total, int denda, String id_mobil) {
