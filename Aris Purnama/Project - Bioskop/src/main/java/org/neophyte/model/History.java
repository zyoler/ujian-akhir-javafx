...
public class History {
    ...
    public History(int idTransaksi, Date tanggal, int jumlahTiket, int idUser, String namaUser, String kdeTiket, int harga, String alamatCustomer, String namaCustomer, String kodeTayang, String tittle, Time jamTayang, int total, String keterangan) {
